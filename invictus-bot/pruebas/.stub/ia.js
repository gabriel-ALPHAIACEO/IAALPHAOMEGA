...
const promptTexto = "PROMPT {{CATALOGO}}";
const promptVision = "PROMPT {{CATALOGO}}";
const promptCotejo = "PROMPT {{CATALOGO}}";
const listaCatalogo = "PROMPT {{CATALOGO}}";
const promptIndexar = "PROMPT {{CATALOGO}}";
