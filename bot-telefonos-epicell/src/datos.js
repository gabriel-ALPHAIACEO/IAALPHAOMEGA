...
// "¿tienen el A57 y hacen envíos?". Ahí contesta el modelo las dos, y
// esto no se mete: solo salta cuando la pregunta va sola.
...
export function ubicacionDe(env) {
  ...
  const texto = direccion
    ? `📍 Aquí nos encuentras:\n\n${direccion}\n\n¡Te esperamos! 😊`
    : "📍 Estamos en la isla de Margarita 😊 Un asesor te pasa la dirección exacta en un momento";
