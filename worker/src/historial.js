...
// lo lee entero. Cuando alguien que preguntó por un Jordan 40 hace tres días
// responde a una historia nueva con un "precio", el modelo tiene delante un
// "Ya busqué: Jordan 40" y contesta el precio del zapato equivocado.
//
...
// pierde el hilo de "y en negro?".

// Con esto caben unas dos frases: suficiente para entender un "y en negro?"
...
// pasado separado y etiquetado, el modelo deja de mezclar el zapato de ayer
// con la pregunta de hoy.
...
// zapato cuando el historial es viejo.
...
export function contextoParaElModelo({
  ...
  if (previo) {
    partes.push(
      ...
      "Esto ya pasó. Sirve para entender referencias como \"y en negro?\" o",
