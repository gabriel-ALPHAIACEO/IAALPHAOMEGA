...
const CON_NOMBRE = [
  ...
  "¡Hola otra vez, {n}! ¿Qué andas buscando?",
...
const SIN_NOMBRE = [
  ...
  "¡Hola de nuevo! ¿Qué andas buscando?",
...
const POR_MOMENTO = {
  ...
  buenas: {
    conNombre: [
      ...
      "¡Buenas, {n}! ¿Qué andas buscando?",
    ],
    sinNombre: [
      "¡Buenas! ¿En qué te puedo ayudar? 😊",
      "¡Buenas! ¿Qué andas buscando?",
    ],
  },
};
